...
public class LoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authentication) throws IOException {
        ...
        ResponseCookie refreshTokenCookie = ResponseCookie.from("refresh", refresh)
                ...
                .secure(true)
                .path("/")
                .sameSite("None") // ✅ SameSite 설정 사파리 쿠키차단 해결
                .maxAge(24 * 60 * 60)
                .build();
        ...
        System.out.println("LoginFilter: Successful authentication");
        System.out.println("Bearer " + access);
        System.out.println("Bearer " + refresh);
